...
#SBATCH --gres=gpu:1
#SBATCH --mem=12G
#SBATCH --job-name=alt_a0.9_d0.99995
#SBATCH -o ./alt_entropy_untuned0.9_a0.99995.out
#SBATCH -e ./alt_entropy_untuned0.9_a0.99995.err
#SBATCH --mail-type=ALL
#SBATCH --array=0,1,2

source $ENT_ENV
ENVIRONMENT="BreakoutNoFrameskip-v4"
VERSION="untuned_0.9_decay0.99995"
ALPHA0=0.9
ALPHADELTA=0.99995
