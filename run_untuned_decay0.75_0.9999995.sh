...
#SBATCH --gres=gpu:1
#SBATCH --mem=12G
#SBATCH --job-name=alt_a0.75_d0.9999995
#SBATCH -o ./alt_entropy_untuned0.75_a0.9999995.out
#SBATCH -e ./alt_entropy_untuned0.75_a0.9999995.err
#SBATCH --mail-type=ALL
#SBATCH --array=0,1,2

source $ENT_ENV
ENVIRONMENT="BreakoutNoFrameskip-v4"
VERSION="untuned_0.75_decay0.9999995"
ALPHA0=0.75
